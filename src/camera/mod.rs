/// Image data types and binary encoding (`ImageBytes`).
pub mod image;
/// Camera-specific enums: `CameraState`, `SensorType`, `GainOffsetMode`, `GuideDirection`.
pub mod types;
...
/// }
/// ```
#[allow(missing_docs)] // ~55 trait methods map 1:1 to ASCOM ICameraV4 — names are self-documenting
pub trait Camera: Device {
    // --- Exposure control ---

    /// Starts an exposure. ASCOM `StartExposure`.
